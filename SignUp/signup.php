...
<body>
    ...
    <!-- ✅ Show popup if error or success -->
        ...
        <section class="signup">
            <div class="container">
                <div class="signup-content">
                    <!-- ✅ Only one form -->
                    <form action="signupValidate.php" method="POST" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="submit" name="submit" style="cursor: pointer" id="submit" class="form-submit" value="Sign up" />
                        </div>
                    </form>

                    <p class="loginhere">
                        Already have an account? <a href="../Login/login.php" class="loginhere-link">Login here</a>
                    </p>
                </div>
            </div>
        </section>
